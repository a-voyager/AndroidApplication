...
public class WaterWaveView extends View {
	 ...
	 * 读取sp配置文件
	 */
	private void readPre(Context context) {
		SharedPreferences sp = context.getSharedPreferences("config",
				context.MODE_PRIVATE);
		flowNum = sp.getString("netLeft", "0MB");
		mWateLevel = sp.getFloat("netPercent", 0.5F);
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		setBackgroundColor(mContext.getResources().getColor(R.color.water_bg));
